...
@Then("^enter valid service URL for all characters$")
...
public void validate_the_output_is_displayed_or_not() {
...
@Then("^enter all starwars characters invalid data$")
public void allCharInvalidData() {
driver.findElement(By.id("interactive")).sendKeys("people200/");
...
@Then("^enter valid service URL for starwars specific character$")
...
@Then("^enter invalid service URL for specific character$")
...
@Then("^enter valid planets/characters valid serviceURL$")
...
@Then("^enter invalid service URL to search planets/characters$")
...
@Then("^keep service URL field blank$")
